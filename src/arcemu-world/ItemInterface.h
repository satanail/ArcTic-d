...
public:
	ARCEMU_INLINE bool VerifyBagSlots(uint8 ContainerSlot, uint8 Slot)
	{
	...
	ARCEMU_INLINE bool VerifyBagSlotsWithBank(uint8 ContainerSlot, uint8 Slot)
	{
		if( ContainerSlot > 0 && (ContainerSlot < INVENTORY_SLOT_BAG_START || ContainerSlot >= INVENTORY_SLOT_BAG_END) )
			return false;
	...
	ARCEMU_INLINE bool VerifyBagSlotsWithInv(uint8 ContainerSlot, uint8 Slot)
	{
		if( ContainerSlot > 0 && (ContainerSlot < INVENTORY_SLOT_BAG_START || ContainerSlot >= INVENTORY_SLOT_BAG_END) )
			return false;
...
public:
	...
	ARCEMU_INLINE uint8 GetCurrentContainerSlot() { return m_containerSlot; }
	ARCEMU_INLINE uint8 GetCurrentSlot() { return m_slot; }
