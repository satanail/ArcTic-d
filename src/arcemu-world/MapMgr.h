...
/////////////////////////////////////////////
	...
	ARCEMU_INLINE const uint32 GenerateGameobjectGuid()
	{
		m_GOHighGuid &= 0x00FFFFFF;
		return ++m_GOHighGuid;
	}

	ARCEMU_INLINE GameObject* GetGameObject(const uint32 guid)
	{
...
////////////////////////////////////////////
	...
	ARCEMU_INLINE DynamicObject* GetDynamicObject(const uint32 guid)
	{
...
////////////////////////////////
	...
	ARCEMU_INLINE bool IsCombatInProgress()
	{ 
...
///////////////////////////////////
	...
	ARCEMU_INLINE uint16 GetAreaID(float x, float y, float z =0)
	{
	...
	ARCEMU_INLINE void SetCollision(bool enable) { collision = enable; }
	ARCEMU_INLINE bool IsCollisionEnabled() { return collision; }
