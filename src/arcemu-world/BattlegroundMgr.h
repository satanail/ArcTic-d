...
public:
	...
	ARCEMU_INLINE bool IsArena() { return (m_type >= BATTLEGROUND_ARENA_2V2 && m_type <= BATTLEGROUND_ARENA_5V5); }
...
public:
	...
	/* Full? */
	ARCEMU_INLINE bool IsFull() { return !(HasFreeSlots(0) || HasFreeSlots(1)); }
