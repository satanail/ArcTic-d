...
public:
	...
	ARCEMU_INLINE uint32	GetFinishedDailiesCount() { return (uint32)m_finishedDailyQuests.size(); }
	...
	ARCEMU_INLINE Group*	GetGroup() { return m_playerInfo != NULL ? m_playerInfo->m_Group : NULL; }
	ARCEMU_INLINE uint32	GetGroupID() { return m_playerInfo != NULL ? m_playerInfo->m_Group? m_playerInfo->m_Group->GetID(): NULL: NULL; }
	...
	ARCEMU_INLINE PlayerPet*	GetPlayerPet(uint8 idx)
	{
	...
	ARCEMU_INLINE AchievementInterface* GetAchievementInterface() { return m_achievementInterface; }
	...
	uint32 ARCEMU_FASTCALL BuildCreateUpdateBlockForPlayer( ByteBuffer *data, Player* target );
	...
	ARCEMU_INLINE int32 GetHealthFromSpell() { return m_healthfromspell; }
	...
	ARCEMU_INLINE float CalcRating(uint32 index) { return CalcPercentForRating(index, m_uint32Values[index]); };
	...
	bool ARCEMU_FASTCALL CompressAndSendUpdateBuffer(uint32 size, const uint8* update_buffer, ByteBuffer *pCompressionBuffer);
	...
	ARCEMU_INLINE AreaTable *GetAreaDBC() { return m_areaDBC; }
	...
	ARCEMU_INLINE void StopPvPTimer() { RemoveFlag(PLAYER_FLAGS, PLAYER_FLAG_PVP_TIMER); m_pvpTimer = 0; }
...
public:
	...
	ARCEMU_INLINE bool HasKnownTitle( int32 title )
	{
...
public:
	...
	ARCEMU_INLINE const uint8 *GetTalentInspectBuffer() { return m_talentInspectBuffer; }
