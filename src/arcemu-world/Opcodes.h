...
enum Opcodes
{
    ...
    CMSG_CANCEL_TRADE                               = 0x11C, // 0x011C
...
enum NPCFlags
{
	...
	UNIT_NPC_FLAG_QUESTGIVER            = 0x00000002,		//2				03		guessed, probably ok
	UNIT_NPC_FLAG_UNK1                  = 0x00000004,		//4				04		NOT SUPPORTED
	UNIT_NPC_FLAG_UNK2                  = 0x00000008,		//8				05		NOT SUPPORTED
	UNIT_NPC_FLAG_TRAINER               = 0x00000010,		//16			06		100%
	UNIT_NPC_FLAG_TRAINER_CLASS         = 0x00000020,		//32			07		100%
	UNIT_NPC_FLAG_TRAINER_PROFESSION    = 0x00000040,		//64			08		100%
	UNIT_NPC_FLAG_VENDOR                = 0x00000080,		//128			09		100%
	UNIT_NPC_FLAG_VENDOR_AMMO           = 0x00000100,		//256			10		100%, general goods vendor
	UNIT_NPC_FLAG_VENDOR_FOOD           = 0x00000200,		//512			11		100%
	...
	UNIT_NPC_FLAG_PETITIONER            = 0x00040000,       //262144		20		100% 786432 = guild petitions, 262144 = arena team petitions
	UNIT_NPC_FLAG_TABARDDESIGNER        = 0x00080000,       //524288		21		100%
	UNIT_NPC_FLAG_BATTLEMASTER          = 0x00100000,       //1048576		22		100%
	UNIT_NPC_FLAG_AUCTIONEER            = 0x00200000,       //2097152		23		100%
	UNIT_NPC_FLAG_STABLEMASTER          = 0x00400000,       //4194304		24		100%
	UNIT_NPC_FLAG_GUILD_BANKER          = 0x00800000,       //8388608		25		cause client to send 998 opcode (CMSG_GUILD_BANKER_ACTIVATE)
	UNIT_NPC_FLAG_SPELLCLICK            = 0x01000000,       //16777216		26		cause client to send 1015 opcode (spell click), dynamic, set at loading and don't must be set in DB
	UNIT_NPC_FLAG_PLAYER_VEHICLE        = 0x02000000,       //33554432		27		players with mounts that have vehicle data should have it set
	UNIT_NPC_FLAG_GUARD                 = 0x10000000,       //268435456		28		custom flag for guards
