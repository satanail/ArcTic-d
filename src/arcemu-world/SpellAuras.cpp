...
void Aura::EventPeriodicLeech(uint32 amount)
{
	...
	SendPeriodicAuraLog(m_casterGuid, m_target, m_spellProto, Amount, -1, 0, (uint32)FLAG_PERIODIC_DAMAGE);
	...
	SendPeriodicAuraLog(m_casterGuid, m_target, m_spellProto, Amount, -1, 0, (uint32)FLAG_PERIODIC_HEAL);
}
