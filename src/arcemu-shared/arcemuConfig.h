...
/** Enable/disable ARC world server cluster support.
 * Warning: ARC will no longer function independantly when built in cluster mode. 
...
/** Enable/disable ARC's Voice Chat support.
 * While not completely finished (but close!) you can link your ARC server to a voice chat
 ...
 * Enable it if you do not plan on using ARC with PostgreSQL or SQLite.
 */
