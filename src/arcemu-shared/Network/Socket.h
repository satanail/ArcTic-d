...
public:
	...
	// Atomic wrapper functions for increasing read/write locks
	ARCEMU_INLINE void IncSendLock() { __sync_add_and_fetch(&m_writeLock, 1); }
	ARCEMU_INLINE void DecSendLock() { __sync_sub_and_fetch(&m_writeLock, 1); }
	ARCEMU_INLINE bool HasSendLock() { return (m_writeLock != 0); }
