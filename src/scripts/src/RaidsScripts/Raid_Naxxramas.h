...
static Coords WebWrapPos[] =
{
	// Left wall
	{ 3515.307861f, -3837.076172f, 302.671753f, 4.388477f, 0 },
	{ 3529.401123f, -3841.910889f, 300.766174f, 4.335070f, 0 },
	{ 3541.990479f, -3851.308350f, 298.685272f, 3.804141f, 0 },
	// Right wall
	{ 3497.262939f, -3949.542969f, 308.138916f, 1.433983f, 0 },
	{ 3510.450928f, -3949.871582f, 309.523193f, 1.613839f, 0 },
...
static Coords CryptGuards[] =
{
	{ 3300.486572f, -3449.479492f, 287.077850f, 3.883793f, 0 },
	{ 3300.568604f, -3503.060059f, 287.077850f, 2.367975f, 0 },
...
static Coords SkelPosPhase1[] =
{
	{ 2660.175781f, -3473.315674f, 262.003967f, 5.252077f, 0 },
	{ 2717.336426f, -3463.309326f, 262.044098f, 3.703270f, 0 },
	{ 2718.720215f, -3524.452881f, 261.943176f, 2.760789f, 0 }
};

static Coords SkelPosPhase2[] =
{
	{ 2660.932129f, -3474.058105f, 262.004730f, 5.765719f, 0 },
	{ 2706.175537f, -3465.862793f, 262.003510f, 4.488667f, 0 },
	{ 2723.024170f, -3472.919434f, 262.102020f, 3.809298f, 0 },
...
static Coords Eruptions[] =
{
	{ 2786.82f, -3647.31f, 273.635f, -0.436332f, 0 },
	{ 2787.77f, -3674.88f, 273.668f, 0.296705f, 0 },
	{ 2789.24f, -3674.88f, 273.669f, -0.366518f, 0 },
	{ 2793.0f, -3646.92f, 273.62f, -0.95993f, 0 },
	{ 2793.97f, -3656.83f, 273.637f, 0.663223f, 0 },
	{ 2795.44f, -3687.74f, 273.622f, -0.506145f, 0 },
	{ 2796.98f, -3671.73f, 273.669f, 2.58308f, 0 },
	{ 2802.32f, -3659.69f, 273.626f, 1.46608f, 0 },
	{ 2803.58f, -3675.67f, 273.666f, -2.80998f, 0 },
	{ 2807.49f, -3668.25f, 273.644f, -1.55334f, 0 },
	{ 2808.35f, -3685.41f, 273.645f, -1.27409f, 0 },
	{ 2811.57f, -3663.93f, 273.623f, 3.00195f, 0 },
	{ 2813.31f, -3699.76f, 273.621f, -1.85005f, 0 },
	{ 2815.57f, -3697.73f, 273.621f, 0.994837f, 0 },
	{ 2817.31f, -3687.08f, 273.621f, 2.60054f, 0 },
	{ 2817.4f, -3684.56f, 273.623f, -0.820303f, 0 },
	{ 2818.81f, -3672.17f, 273.629f, -1.3439f, 0 },
	{ 2819.54f, -3677.43f, 273.638f, 1.51844f, 0 },
	{ 2821.09f, -3691.91f, 275.804f, 2.79252f, 0 }
};
...
class HeiganTheUncleanAI : public MoonScriptBossAI
{
	...
	set< pair< uint32, FissureTriggerAI* > >	mFissureTriggers;
	int32										mPhaseSwitchTimer;
...
/////////////////////////////////////////////////////////////////////////////////
////// Fissure Trigger
#define CN_FISSURE_TRIGGER						7835	// Unused Entry for now
...
static Coords Spores[] =
{
	{ 2880.517334f, -4027.450684f, 273.680695f, 0.848522f, 0 },
	{ 2938.914307f, -4027.245850f, 273.617340f, 2.419318f, 0 },
	{ 2938.526611f, -3968.206543f, 273.524963f, 3.829108f, 0 },
	{ 2879.754883f, -3968.288574f, 273.633698f, 5.525566f, 0 }
};
...
void DeathKnightUnderstudyAI::AIUpdate()
{
	if ( !mIsControlled && _unit->HasFlag( UNIT_FIELD_FLAGS, UNIT_FLAG_PLAYER_CONTROLLED_CREATURE ) )
	{
		...
		if ( PlayerPtr != NULL )
		{
			...
			list< uint32 > Spells;
			Spells.push_back( DEATH_KNIGHT_UNDERSTUDY_BLOOD_STRIKE );
			Spells.push_back( DEATH_KNIGHT_UNDERSTUDY_BONE_BARRIER );
			Spells.push_back( DEATH_KNIGHT_UNDERSTUDY_TAUNT );
	...
	{
		if ( !_unit->HasFlag( UNIT_FIELD_FLAGS, UNIT_FLAG_PLAYER_CONTROLLED_CREATURE ) )
			mIsControlled = false;
	};
...
/////////////////////////////////////////////////////////////////////////////////
////// Embalming Slime
#define CN_EMBALMING_SLIME						16375
...
public:
    ...
    void OnDied(Unit* mKiller)
    {
		...
		else if(!hrsone->isAlive() && !hrstwo->isAlive() && chest)
		{
			RemoveAIUpdateEvent();
		}
		else if(chest)
...
public:
	...
	void AIUpdate()
	{
		...
		{
			if( _gameobject->CalcDistance( _gameobject, plr ) <= 1.8f )
			{
				plr->SafeTeleport( plr->GetMapId(), plr->GetInstanceID(), 3498.280029f, 3498.280029f, 144.968002f, 1.313240f );
			}
		}
		else
		{
			plr->BroadcastMessage("You need to kill all bosses before going to Frostwyrm Lair."); 
		}
	}
}; 
