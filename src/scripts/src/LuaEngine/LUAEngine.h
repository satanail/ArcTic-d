...
*/
#define LUA_TO_UNIT(ptr) ((Unit*)ptr)
#define LUA_TO_CREATURE(ptr) ((Creature*)ptr)
#define LUA_TO_PLAYER(ptr) ((Player*)ptr)
#define LUA_TO_GAMEOBJECT(ptr) ((GameObject*)ptr)
#define LUA_TO_ITEM(ptr) ((Item*)ptr)
#define LUA_TO_RAW(ptr) ptr
#define FROM_RAW(ptr) ptr
